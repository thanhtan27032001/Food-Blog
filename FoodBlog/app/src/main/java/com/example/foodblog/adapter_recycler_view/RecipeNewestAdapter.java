...
public class RecipeNewestAdapter extends RecyclerView.Adapter<RecipeNewestAdapter.MyViewHolder> {
    private RecipesNewestActivity context;
    private ArrayList<Recipe> recipes;
    private int layoutResource;

    public RecipeNewestAdapter(RecipesNewestActivity context, ArrayList<Recipe> recipes) {
    ...
    @NonNull
    @Override
    public RecipeNewestAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recipe_small, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecipeNewestAdapter.MyViewHolder holder, int position) {
