...
public class RecipeOtherUserAdapter extends RecyclerView.Adapter<RecipeOtherUserAdapter.MyViewHolder> {

    private UserWallActivity context;
    private User user;
    private ArrayList<Recipe> recipes;
    private int layoutResource;

    public RecipeOtherUserAdapter(UserWallActivity context, User user, ArrayList<Recipe> recipes, int layoutResource) {
    ...
    @NonNull
    @Override
    public RecipeOtherUserAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(layoutResource, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecipeOtherUserAdapter.MyViewHolder holder, int position) {
